...
#ifndef OsiShallowPackedVector_H
#define OsiShallowPackedVector_H
...
read only access to to the data.  An OsiSparsePackedVector
...
*/
class OsiShallowPackedVector : public OsiPackedVectorBase {
   friend void OsiShallowPackedVectorUnitTest();
...
public:
   ...
   //@{
   /** Default constructor. */
   OsiShallowPackedVector(bool testForDuplicateIndex = true);
   ...
   */
   OsiShallowPackedVector(int size,
			  const int * indices, const double * elements,
			  bool testForDuplicateIndex = true);
   /** Copy constructor from the base class. */
   OsiShallowPackedVector(const OsiPackedVectorBase &);
   /** Copy constructor. */
   OsiShallowPackedVector(const OsiShallowPackedVector &);
   /** Destructor. */
...
//#############################################################################
/** A function that tests the methods in the OsiShallowPackedVector class. The
