...
#ifndef _OsiFmpSolverInterface_hpp_
#define _OsiFmpSolverInterface_hpp_

#if (defined(__MINGW32__) || defined(__CYGWIN32__)) && !defined(FMPMSDLL)
#  define FMPMSDLL
#endif
...
public:
  ...
  */
  ...
  //@{
    ...
    /// Assignment operator 
    OsiFmpSolverInterface &    
    operator=(const OsiFmpSolverInterface& rhs);
...
private:
  ...
  //@{
		/** These scalars and vectors represent are the external interface of FortMP
...
/*! Primal Solution vector */
	...
	/**@name Cached information derived from the FortMP model */
    //@{
      /// Pointer to dense vector of row sense indicators
     mutable char *rowsense_;
  
      /// Pointer to dense vector of row right-hand side values
     mutable double *rowrhs_;
...
//#############################################################################
/** A function that tests the methods in the OsiFmpSolverInterface class. The
